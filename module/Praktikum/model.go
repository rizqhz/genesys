...
type PraktikumModel struct {
	...
	MataPraktikum     mata_praktikum.MataPraktikumModel `gorm:"foreignKey:KodeMataPraktikum;references:Kode;constraint:OnUpdate:CASCADE,OnDelete:CASCADE"`
	...
	Jadwal            penjadwalan.PenjadwalanModel      `gorm:"foreignKey:JadwalID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE"`
